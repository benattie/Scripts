#script para medir escalones, corregido para la escala 10 kA del perfilómetro mecánico
...
low(x)=a*x+b
sup(x)=c*x+d
fit [ulow:usup] low(x) name u 1:($2*101/93.91) via a,b
fit [vlow:vsup] sup(x) name u 1:($2*101/93.91) via c,d
replot low(x), sup(x)
