#script para medir escalones, corregido para la escala 1000 A del perfilómetro mecánico
...
low(x)=a*x+b
sup(x)=c*x+d
fit [ulow:usup] low(x) name u 1:($2*101/96.96) via a,b
fit [vlow:vsup] sup(x) name u 1:($2*101/96.96) via c,d
replot low(x), sup(x)
